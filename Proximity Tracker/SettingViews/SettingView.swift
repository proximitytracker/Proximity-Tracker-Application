    ...
    var studySection: some View {
        CustomSection(header: "study_settings", footer: "survey_description_short") {
            ...
            .alert(item: $dataDeletionState, content: { dataDeletionState in
                ...
                case .failed:
                    return _(title: Text("deletion_failed"), message: Text("deletion_failed_message"), dismissButton: Alert.Button.cancel())
                case .succeeded:
...
*/
    ...
    func sendStudyDeletionMail(studyUUID: String) {
        ...
        let subjectContent = "Proximity Tracker Study Data Deletion Request".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)
